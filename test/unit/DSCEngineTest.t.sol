...
contract DSCEngineTest is Test {
    ...
    function testRevertsIfTokenLengthDoesntMachPriceFeeds() public {
        tokenAddress.push(weth);
        priceFeedAddreses.push(wethUsdPriceFeed);
        priceFeedAddreses.push(wbtcUsdPriceFeed);

        vm.expectRevert(DSCEngine.DSCEngine__TokenAddressesAndPriceFeedAddessesMustBeSameLength.selector);
        new DSCEngine(tokenAddress, priceFeedAddreses, address(dsc));
    }
